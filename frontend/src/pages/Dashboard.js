  ...
  return (
    <div className="space-y-8" data-testid="dashboard-page">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <KpiCard testid="kpi-collection-pct" label="Collection %" value={`${k.collPct.toFixed(1)}%`} accent={k.collPct >= 80 ? "success" : k.collPct >= 50 ? "warning" : "danger"} sub="Collected ÷ Last Week Target" icon={Gauge} delay={0.18}
